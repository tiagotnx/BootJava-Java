...
public class Exercicio1 {
	...
	public static void main(String[] args) {
		...
		nota4 = sc.nextDouble();
		System.out.println("Insira o número de faltas do aluno 1: ");
		faltas = sc.nextInt();
		...
		System.out.printf("O aluno 1 teve a média de %.2f pontos com presença de %.1f por cento e está %s na disciplina de %s",
